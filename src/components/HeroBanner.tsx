...
const styles = StyleSheet.create({
  ...
  metadata: {
    ...
    gap: isMobile ? spacing.sm : spacing.base,
    flexWrap: 'wrap',
  },
  ratingContainer: {
    flexDirection: 'row',
  ...
  description: {
    ...
    fontSize: isTV ? typography.size.xl : isMobile ? typography.size.sm : typography.size.lg,
    lineHeight: isTV ? 32 : isMobile ? 20 : 28,
    marginBottom: isMobile ? spacing.lg : spacing.xl,
    fontWeight: '400' as any,
    maxWidth: isTV ? 800 : isMobile ? '100%' : 550,
  ...
  playButton: {
    ...
    paddingHorizontal: isTV ? spacing.xxl : isMobile ? spacing.lg : spacing.xl,
    paddingVertical: isTV ? spacing.lg : isMobile ? spacing.sm : spacing.md,
    borderRadius: borderRadius.button, // Minimal 4-6px corners
    gap: spacing.sm,
    minWidth: isTV ? 180 : isMobile ? 100 : 140,
    // No heavy shadows
  },
  playIcon: {
  ...
  playText: {
    ...
    fontSize: isTV ? typography.size.lg : isMobile ? typography.size.sm : typography.size.md,
  ...
  infoButton: {
    ...
    borderRadius: borderRadius.button, // Minimal 4-6px corners
    gap: spacing.sm,
    minWidth: isTV ? 160 : isMobile ? 90 : 130,
    borderWidth: 2,
  ...
  favoriteButton: {
    width: isTV ? 52 : isMobile ? 36 : 44,
    height: isTV ? 52 : isMobile ? 36 : 44,
    borderRadius: isTV ? 26 : isMobile ? 18 : 22,
